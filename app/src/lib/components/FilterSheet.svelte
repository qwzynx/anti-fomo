...
<button
  onclick={() => (open = true)}
  class="flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm font-semibold dark:border-zinc-800 dark:bg-zinc-900"
>
  <span>⚙️ Filters</span>
  {#if activeCount > 0}
...
{#if open}
  ...
  >
    ...
    <div
      ...
      class="animate-slide-up safe-bottom max-h-[85vh] w-full overflow-y-auto rounded-t-3xl border-t border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900"
    >
