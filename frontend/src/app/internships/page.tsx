      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-10">
        <div className="mb-6">
          <h2 className="mb-1 flex items-center gap-2.5 text-3xl font-bold">
            <BriefcaseIcon className="h-7 w-7 text-brand-soft-fg" />
            Internship hub
          </h2>
        ...
        <div className="mb-8 rounded-2xl border border-line bg-surface p-4">
          ...
          <div className="mt-3 flex items-center gap-3 border-t border-line pt-3">
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg text-sm font-semibold text-muted transition-colors hover:text-foreground"
            >
              <ChevronDownIcon
              ...
              {activeFilters > 0 && (
                <span className="ml-1 rounded-full bg-brand px-1.5 py-0.5 text-[10px] font-bold text-brand-fg">
                  {activeFilters}
                </span>
              )}
            </button>
            {activeFilters > 0 && (
              <button
                onClick={clearAll}
                className="ml-auto text-xs font-semibold text-brand-soft-fg hover:underline"
              >
                Clear filters
              </button>
            )}
